...
\f0\fs24 \cf0 import \{ FileText, TestTube, Shield, Lock, GitBranch, Users, Building2, Briefcase, User, CheckCircle2 \} from "lucide-react";\
...
\}\
\
export function ProductPage(\{ onBack, onMoreInfoClick, onHowItWorksClick, onSecurityClick, onPricingClick \}: ProductPageProps) \{\
  return (\
        ...
        <div className="max-w-7xl mx-auto px-6 py-24 mt-16">\
          ...
          <header className="mb-24 text-center max-w-4xl mx-auto">\
            ...
            <p className="text-xl text-muted-foreground mb-4">\
              AI-powered scope clarity, test generation, and traceability \'97 built for real-world delivery.\
            </p>\
            <p className="text-base text-muted-foreground/80">\
              ScopeTraceAI acts as an intelligence layer between requirements, testing, and delivery \'97 bringing structure, confidence, and auditability to the software lifecycle.\
            </p>\
          </header>\
\
...
\
              ...
              <div className="bg-card/30 border border-border/50 rounded-lg p-8 hover:border-primary/30 transition-colors">\
                ...
                <p className="text-muted-foreground leading-relaxed">\
                  Generate structured test plans and traceability matrices directly from approved scope \'97 without manual translation.\
                </p>\
              </div>\
\
          ...
          <section className="mb-32">\
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">\
              <div className="bg-card/30 border border-border/50 rounded-lg p-8 text-center">\
                ...
                <p className="text-sm text-muted-foreground">\
                  Developers who need clear, testable requirements before writing code \'97 reducing rework and miscommunication.\
                </p>\
              </div>\
\
              <div className="bg-card/30 border border-border/50 rounded-lg p-8 text-center">\
